...
static const int iterations = 80000;
/// [m] --- Uniformly adds a padding around the vehicle
static const double bloating = 0;
/// [m] --- The width of the vehicle
static const double width = 0.5 + 2 * bloating;     //0.6
/// [m] --- The length of the vehicle
static const double length = 0.5 + 2 * bloating;       //0.6
/// [m] --- The minimum turning radius of the vehicle
static const float r = 6;
/// [m] --- The number of discretizations in heading
static const int headings = 72;   //72
...
/// [m] --- The  Rectangular side length of pcl filter squar     sqrt(2)=1.4142=sqrt(length*2+width*2);
static const double squarLength = 1.4142;
/// [m] --- The cell size of the 2D grid of the world
static const float cellSize = gridSize;    //0.5
// /// [m] --- Length of the map
// static const float mapLength = 27;
// ///  ---map grids number per row
// static const int   volnum= 90;    //map grids number
